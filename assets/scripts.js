...
function setTheme() {
    ...
    if (userWantsDarkMode()) {
        ...
        buttons.forEach(function(el) {
            el.src = "https://raw.githubusercontent.com/InfernoAsura/MyPortfolio/refs/heads/main/images/light-mode.svg";
        });
    } else {
        document.documentElement.classList.remove('dark');
        buttons.forEach(function(el) {
            el.src = "https://raw.githubusercontent.com/InfernoAsura/MyPortfolio/refs/heads/main/images/dark-mode.svg";
        });
    }
}
setTheme();
